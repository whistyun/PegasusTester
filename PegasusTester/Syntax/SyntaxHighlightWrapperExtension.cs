...
namespace PegasusTester.Syntax
{
    public class SyntaxHighlightWrapperExtension : MarkupExtension
    {
        ...
        public SyntaxHighlightWrapperExtension(string baseSyntaxResource, string colorKey)
        {
            this.definition = AvalonEditHighlightingLoader.Load(baseSyntaxResource);
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            return new MultiBinding()
            {
                ...
                Converter = new SyntaxHighlightWrapperConverter(definition)
            };
        }
        ...
        class SyntaxHighlightWrapperConverter : IMultiValueConverter
        {
            ...
            public SyntaxHighlightWrapperConverter(IHighlightingDefinition definition)
            {
            ...
            public object Convert(IList<object> values, Type targetType, object parameter, CultureInfo culture)
            {
                ...
                try
                {
                    return new HighlightWrapper(definition, foreColor);
                }
                catch (Exception e)
                {
